...
1. **Given** the backend `src/media` directory
   ...
   **Then** it must contain `README.md` documenting the S3/Cloudinary streaming and Sharp.js pipeline
...
- [x] Create `README.md` documenting S3/Cloudinary Direct Upload & Sharp.js strategy
...
- **Reference:** `04-CORE-DECISIONS.md` - Decision 10 & 11 (Streaming to S3/Cloudinary, Sharp.js).

## Dev Agent Record

### Implementation Notes
- Created `MediaModule` in `backend/v1_nestjs/src/media`.
- Established `README.md` with S3/Cloudinary and Sharp.js strategy details.
